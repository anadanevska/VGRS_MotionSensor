...
#define COLOR_LIST_SIZE 6
uint32_t colors[COLOR_LIST_SIZE] = {LCD_COLOR_GREEN, LCD_COLOR_RED, LCD_COLOR_YELLOW, LCD_COLOR_MAGENTA, LCD_COLOR_CYAN, LCD_COLOR_ORANGE};
...
#define BUTTON_X (BSP_LCD_GetXSize() - BUTTON_RADIUS - 10)
#define BUTTON_Y (BSP_LCD_GetYSize() - BUTTON_RADIUS - 10)

osSemaphoreId_t syncSemaphoreHandle;
